...
public class FlowerSlotUI : MonoBehaviour
{
    ...
    private FlowerShopUI shop;

    public void Initialize(FlowerUIData data, FlowerShopUI shopRef, bool isOwned, Confirm confirmPannel)
    {
        shop = shopRef;
        ...
        flowerImage.sprite = data.sprite;
